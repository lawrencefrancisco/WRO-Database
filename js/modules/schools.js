    ...
    content.innerHTML = `
      <div class="page-view space-y-6">
        ...
        <div class="flex flex-wrap items-center gap-3">
          ...
          <button onclick="BulkImport.open('schools')" class="px-4 py-2 rounded-xl text-sm font-semibold transition flex items-center gap-2" style="background:rgba(246,201,69,0.12);color:#F6C945;border:1px solid rgba(246,201,69,0.25);">
