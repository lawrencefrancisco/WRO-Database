-- ============================================================
-- WRO Philippines DBMS – Judge Module Migration
-- Replaces the old scoring-based `judging` table with a new
-- `judges` master-data table for competition judge records.
--
...
-- Create the new judges master-data table
...
SELECT 'Migration complete: judges table is ready.' AS result;
