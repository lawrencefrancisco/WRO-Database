...
CREATE TABLE IF NOT EXISTS `coaches` (
  ...
  `certifications` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `years_coaching` int DEFAULT '0',
  `previous_awards` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `schools` (
  ...
  `deped_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
